...
class Paypal extends Component {
    render() {
		...
		const client = {
            sandbox:    'ATq5vxn5D_TOF-XkslphJCjdmT-t-WaXN-IZILI1SvR6OVjlylOWjB9PHSGGiTzZuiAjdOyaEcyT-7is',
            production: 'AbaS3eEoGcRZbmmsuQOgkBQI69z5PVvD1aCKScMFUAbSYpdNSFlNnUOyFZh-m5H36i5iMmOp3oc6kQOv',
        }  
		...
		// NB. You can also have many Paypal 
         
        return (
            <PaypalExpressBtn client={client} currency={currency} total={total} env={env} />
        );
    }
} 

Paypal.contextType = MyContext
